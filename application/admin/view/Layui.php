...
class Layui extends Paginator
{
    ...
    public function render()
    {
        if ($this->hasPages()) {
            if ($this->simple) {
                return sprintf(
                    '<div class="layui-box layui-laypage layui-laypage-default" id="pager">%s %s</div>',
                ...
                return sprintf(
                    '<div class="layui-box layui-laypage layui-laypage-default" id="pagination">%s %s %s</div>',
                    $this->getPreviousButton(),
                    $this->getLinks(),
                    $this->getNextButton()
                );
